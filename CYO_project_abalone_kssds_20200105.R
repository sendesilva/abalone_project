...
# shucked weight, viscera weight, shell weight) in addition to the the number of shell rings 
...
## Determining accuracy of recommender system
...
## Model 4: LR - Using all attributes
...
rmse_model_4
rmse_results <- bind_rows(rmse_results, data_frame(method="Model 4: LR - using all attributes",
                                                   RMSE = rmse_model_4 ))
rmse_results %>% knitr::kable()


## Model 5: LR - Using all attributes less length
...
#  TEST4 rings vs all physical characteristics excluding sex
